...
public class OrderPayTimeoutWithoutCep {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 读取数据并转换成POJO类型
        URL resource = OrderPayTimeoutWithoutCep.class.getResource("/OrderLog.txt");
        ...
        // 自定义处理函数，主流输出正常支付订单事件，侧输出流输出超时事件
        ...
        public void processElement(OrderEvent value, Context ctx, Collector<OrderResult> out) throws Exception {
            ...
            if ("create".equals(value.getEventType())) {
                ...
                if (isPayed) {
                    ...
                    // 1.2 如果没有支付过，注册15分钟之后的定时器，开始等待支付事件
